...
public class Motocykl extends PojazdSilnikowy {
    ...
    public Motocykl(String marka, String model, int rokProdukcji, String kolor, double waga, double cenaBazowa, String status, String wymaganeUprawnienia, String vin, String nrRejestracyjny, double pojemnoscSilnika, int liczbaMiejsc, String paliwo, boolean czyMaKufry, String typ) {
