...
public class SamochodOsobowy extends PojazdSilnikowy {
    ...
    public SamochodOsobowy(String marka, String model, int rokProdukcji, String kolor, double waga, double cenaBazowa, String status, String wymaganeUprawnienia, String vin, String nrRejestracyjny, double pojemnoscSilnika, int liczbaMiejsc, String paliwo, String nadwozie, int iloscDrzwi) {
